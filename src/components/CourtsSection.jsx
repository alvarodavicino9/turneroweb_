      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          {courts.map((court, i) => (
            ...
            >
              <div className="pointer-events-none absolute -right-10 -top-10 h-40 w-40 rounded-full bg-ember-500/10 blur-2xl transition group-hover:bg-ember-500/20" />
              <span className="mb-4 inline-flex h-11 w-11 items-center justify-center rounded-full bg-ember-500/15 text-ember-400">
                🏀
              </span>
              ...
              <a
                href="#reservar"
                className="mt-5 inline-flex items-center gap-1 text-sm font-semibold text-ember-400 transition hover:text-ember-300"
              >
